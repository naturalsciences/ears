 ...
 * notify listeners
 *
 * when the runnable thread has completed. To use this class, first extend it
 * and implement
 *
 * the doRun function - the doRun function is where all work should be
 * performed. Add any listener to update upon completion, then  *
