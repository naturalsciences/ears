...
import be.naturalsciences.bmdc.ontology.entities.IEarsTermLabelNl;
import be.naturalsciences.bmdc.ontology.entities.Term;
import java.io.Serializable;
import java.net.URI;
import thewebsemantic.Id;

public class EarsTermLabelNl implements IEarsTermLabelNl, Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EarsTermLabelNl)) {
            return false;
        }
        EarsTermLabelNl other = (EarsTermLabelNl) object;
