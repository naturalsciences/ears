...
import be.naturalsciences.bmdc.ontology.entities.IEarsTermLabelEn;
import be.naturalsciences.bmdc.ontology.entities.Term;
import java.io.Serializable;
import java.net.URI;

public class EarsTermLabelEn implements IEarsTermLabelEn, Serializable {

    //private static final long serialVersionUID = 1L;
    protected URI uri;
    protected Long id;

    String prefLabel; //package public

    String altLabel; //package public

    String definition; //package public

    private EarsTerm earsTerm; //package public

    public EarsTermLabelEn() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EarsTermLabelEn)) {
            return false;
        }
        EarsTermLabelEn other = (EarsTermLabelEn) object;
