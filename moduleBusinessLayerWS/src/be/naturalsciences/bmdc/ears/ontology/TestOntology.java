 ...
 * @author thomas
 */
public class TestOntology extends OntologyModel {

    public TestOntology(File localFile, boolean killModelAfterNodeCalculation, boolean reasoning) throws FileNotFoundException, IOException {
        super(localFile, killModelAfterNodeCalculation, reasoning);
    }

    public TestOntology(File localFile) {
        super(localFile);
    }

    public static String getPreferredName() {
        return OntologyConstants.TEST_ONTOLOGY_FILENAME_NO_EXT;
    }
