...
@TopComponent.Description(
        preferredID = "CreateProgramTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_NEVER
)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "be.naturalsciences.bmdc.ears.topcomponents.CreateProgramTopComponent")
@ActionReferences({
...
@Messages({
    ...
    "CTL_CreateProgramTopComponent=Create new program",
    "HINT_CreateProgramTopComponent=Create a new program by choosing PI,..."
})
public final class CreateProgramTopComponent extends AbstractProgramTopComponent implements TaskListener {

    public CreateProgramTopComponent() {
        super();
        ...
        super.piOrgGreyTextField = o_collateCentreResult;
    ...
    private void initComponents() {
        ...
        programNamePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.programNamePanel.border.title"))); // NOI18N
        programNamePanel.setOpaque(false);
        programNamePanel.setPreferredSize(new java.awt.Dimension(627, 45));

        o_programId_Attribut.setText(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.o_programId_Attribut.text")); // NOI18N
        ...
        piNamePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.piNamePanel.border.title"))); // NOI18N
        piNamePanel.setOpaque(false);
        piNamePanel.setPreferredSize(new java.awt.Dimension(627, 45));

        firstNameTextbox.setText(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.firstNameTextbox.text")); // NOI18N
        ...
        lastNameTextbox.setText(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.lastNameTextbox.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.jLabel2.text")); // NOI18N
        ...
        programDescriptionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.programDescriptionPanel.border.title"))); // NOI18N
        ...
        programProjectPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.programProjectPanel.border.title"))); // NOI18N
        programProjectPanel.setToolTipText(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.programProjectPanel.toolTipText")); // NOI18N
        programProjectPanel.setOpaque(false);

        org.openide.awt.Mnemonics.setLocalizedText(addProject, org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.addProject.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeProject, org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.removeProject.text")); // NOI18N
        ...
        piOrganisationPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.piOrganisationPanel.border.title"))); // NOI18N
        ...
        o_collateCentreResult.setText(org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.o_collateCentreResult.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(o_saveProgram, org.openide.util.NbBundle.getMessage(CreateProgramTopComponent.class, "CreateProgramTopComponent.o_saveProgram.text")); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(programDescriptionPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(programProjectPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(piNamePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 701, Short.MAX_VALUE)
                    .addComponent(programNamePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 694, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void postProgram() {
        if (formValidates()) {
            ...
            if (actualProgram != null) {
                ...
                AbstractProgramTopComponent.ProgramPoster tsk = new CreateProgramTopComponent.ProgramPoster(progr, response);
