 ...
 */
@TopComponent.Description(preferredID = "OntologyFileBrowser", persistenceType = TopComponent.PERSISTENCE_ALWAYS)
//@NavigatorPanel.Registration(mimeType = "application/rdf+xml", displayName = "Browse tree")
@TopComponent.Registration(mode = "explorer", openAtStartup = false)
@ActionID(category = "Window", id = "be.naturalsciences.bmdc.ontology.browser.OntologyFileBrowser")
@ActionReferences({
...
@NbBundle.Messages({"CTL_OntologyFileBrowserAction=Browse trees",
    "CTL_OntologyFileBrowser=Browse trees",
    "HINT_OntologyFileBrowser=Browse the different trees"})
public final class OntologyFileBrowser extends TopComponent implements ExplorerManager.Provider, DirectoryChangeListener, TaskListener {
    ...
    public OntologyFileBrowser() {
        ...
        //RdfFileTypeDataObject rdfO =  OntologyNodeChildFactory2.fileToDataObject(new File(""));
    ...
    public void actionPerformed(ActionEvent ae) {
        //Path newPath = (Path) ae.getSource();
        refresh();
    }
}
