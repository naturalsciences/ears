 ...
 */
@ActionID(id = "be.naturalsciences.bmdc.ears.ontology.rdf.NewRdfFileTypeAction", category = "File")
@ActionRegistration(displayName = "#CTL_NewRdfFileTypeAction")
@ActionReference(path = "Menu/File", position = 10)
@Messages("CTL_NewRdfFileTypeAction=New program tree")
public class NewRdfFileTypeAction implements ActionListener {

    private RdfFileTypeDataObject context;

    //private final ScopeMap scope = ScopeMap.PROGRAM_SCOPE;

    /*public NewRdfFileTypeAction() {
